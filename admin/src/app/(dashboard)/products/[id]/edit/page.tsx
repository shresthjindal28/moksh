...
export default function EditProductPage() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((res) => {
        ...
        setValue("price", p.price ?? undefined);
        setValue("categoryId", p.category.id);
        setValue("whatsappNumber", p.whatsappNumber ?? "");
  ...
  async function onSubmit(data: FormData) {
    try {
      await api.put(`/products/${id}`, { ...data, images: imageUrls });
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-semibold text-foreground mb-6">Edit Product</h1>
